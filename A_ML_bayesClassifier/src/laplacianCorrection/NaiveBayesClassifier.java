...
public class NaiveBayesClassifier {
	...
	public void naiveClassifier(String[][] D,String[][] testExample){
		 ...
		 for(int i=0;i<D[0].length-3;i++){
			 ...
			 goodPro = goodPro*((1+new Data().getTwoSpeAttributeNumber(D, attributeName, attributeValue, "结果", "1"))/(goodNumber+new Data().getAttributeValueTypeNumber(D, attributeName)));
			 badPro = badPro*((1+new Data().getTwoSpeAttributeNumber(D, attributeName, attributeValue, "结果", "0"))/(badNumber+new Data().getAttributeValueTypeNumber(D, attributeName)));
		 }
